...
// Define a single required method, `fn bite(self: &mut Self)`.  We will call this method when we want to bite something.
trait Bite {
...
// Challenge: Uncomment the code below. Create a generic `bunny_nibbles` function that:
